...
import 'package:upload_download/models/fab_mini_menu.dart';
import 'package:upload_download/models/file.dart' as model;
import 'package:upload_download/services/file_service.dart';
import 'package:upload_download/views/file_preview.dart';
import 'package:upload_download/views/file_row.dart';
import 'package:upload_download/util/util.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void _buildFabMenus() {
    fabItems = [
      FabMiniMenu(icon: Icons.cloud_upload, action: () => _uploadFile(File(_imageFile.path))),
      FabMiniMenu(
  ...
  void _pickImage(ImageSource source) async {
    var ip = new ImagePicker();
    _imageFile = await ip.getImage(source: source);
    setState(() {});
  }
  ...
  void _chooseFile() async {
    ...
    var fileName = fileNames.paths[0];
    setState(() {
      _imageFile = PickedFile(fileName);
    });
  }
